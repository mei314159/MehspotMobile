...
namespace mehspot.iOS.Controllers.Badges.DataSources.Search
{
    ...
    public class PetSitterFilterTableSource : SearchFilterTableSource<SearchPetSitterDTO>
    {
        public PetSitterFilterTableSource (BadgeService badgeService, int badgeId) : base (badgeService, badgeId)
        {
        }

        public override async Task InitializeAsync ()
        {
            var petTypes = await GetOptionsAsync (BadgeService.BadgeKeys.PetSitterPetType, true);
