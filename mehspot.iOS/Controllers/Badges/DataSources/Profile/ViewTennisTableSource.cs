...
namespace mehspot.iOS.Controllers.Badges.BadgeProfileDataSource
{
    ...
    public class ViewTennisTableSource : ViewBadgeProfileTableSource<BadgeProfileDTO<TennisProfileDTO>>
    {
        ...
        public override Task InitializeAsync (BadgeProfileDTO<TennisProfileDTO> profile)
        {
            ...
            Cells.Add (TextViewCell.Create (profile.BadgeValues.TennisZip, "Court Zip"));
            Cells.Add (TextViewCell.Create (profile.BadgeValues.TennisSubdivision, "Court Subdivision"));
